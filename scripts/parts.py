...
PARTS = (
    ...
    ("решения", ["harness/decisions.py"],
     ("src/fot_planner/harness_local/decisions.py", "app/main.py", "app/chat.py",
      "app/db.py", "app/actuality.py", "harness/decisions.py")),
    ...
    ("жизненный цикл прогонов", ["harness/lifecycle.py"],
     ("app/main.py", "app/db.py", "app/chat.py", "src/fot_planner/harness_local/",
      "harness/lifecycle.py")),
    ("поведение чата", ["harness/chat.py"],
     ("app/chat.py", "app/main.py", "app/actuality.py", "harness/chat.py")),
