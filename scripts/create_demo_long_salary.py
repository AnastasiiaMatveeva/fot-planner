...
# ФОТ «впритык»: оклады на длинных + надбавки янв–мар (кратких ещё нет).
# C_LONG_ENG: (100+90)*12 + (30+25)*3 = 2_280_000 + 165_000
FOT_LONG_ENG = 2_445_000
# C_LONG_ANALYTICS: (80+80)*12 + (20+25)*3 = 1_920_000 + 135_000
FOT_LONG_ANALYTICS = 2_055_000
        ...
        [
            {
                ...
                "вес отклонения равномерного освоения": 10_000,
