...
Зачем отдельный слой: якорный разбор (`docs/ui/extract.py`) требует, чтобы в
документе была
...
человеко-месяцах, средняя стоимость одного человеко-месяца в рублях, и, если
названо, количество привлекаемых специалистов — headcount, человек. Это
